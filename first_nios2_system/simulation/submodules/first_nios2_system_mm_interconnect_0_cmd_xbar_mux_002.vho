...
--synthesis_resources = 
 ...
 ENTITY  first_nios2_system_mm_interconnect_0_cmd_xbar_mux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END first_nios2_system_mm_interconnect_0_cmd_xbar_mux_002;

 ARCHITECTURE RTL OF first_nios2_system_mm_interconnect_0_cmd_xbar_mux_002 IS
 ...
 BEGIN
	...
	src_data <= ( sink0_data(100 DOWNTO 0));
	src_endofpacket <= sink0_endofpacket;
	src_startofpacket <= sink0_startofpacket;
	src_valid <= sink0_valid;

 END RTL; --first_nios2_system_mm_interconnect_0_cmd_xbar_mux_002
