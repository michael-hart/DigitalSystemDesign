...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_dataa
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_datab
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_ipending
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_status
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_estatus
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_n
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_a
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_b
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_c
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_readra
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_readrb
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_writerc
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_result
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_clk_en
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_start
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_done
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ctrl_custom_multi
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_dataa
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_datab
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_ipending
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_status
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_start
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_done
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/M_ci_multi_stall
