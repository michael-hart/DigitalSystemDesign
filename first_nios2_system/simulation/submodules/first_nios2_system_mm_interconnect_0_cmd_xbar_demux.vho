...
--synthesis_resources = 
 ...
 ENTITY  first_nios2_system_mm_interconnect_0_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END first_nios2_system_mm_interconnect_0_cmd_xbar_demux;

 ARCHITECTURE RTL OF first_nios2_system_mm_interconnect_0_cmd_xbar_demux IS
 ...
 END RTL; --first_nios2_system_mm_interconnect_0_cmd_xbar_demux
